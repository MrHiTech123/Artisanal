...
ARTISANAL_ORE_VEINS = {
    'surface_sweet_crude_oil': Vein.new('sweet_crude_oil', 450, 15, 40, 130, 1, SEDIMENTARY_ROCKS),
    'surface_sour_crude_oil': Vein.new('sour_crude_oil', 210, 20, 40, 130, 1, SEDIMENTARY_ROCKS),
    'normal_sweet_crude_oil': Vein.new('sweet_crude_oil', 600, 45, -30, 70, 1, SEDIMENTARY_ROCKS),
    'normal_sour_crude_oil': Vein.new('sour_crude_oil', 300, 45, -30, 70, 1, SEDIMENTARY_ROCKS)
}
...
def generate_fluid_tags():
    ...
    rm.fluid_tag('water_vision', 'artisanal:sweet_crude_oil', 'artisanal:sour_crude_oil')
