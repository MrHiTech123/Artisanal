...
public class ArtisanalFluidType extends FluidType {
    private final Vector3f color;
    private final float shaderFogStart;
    private final float shaderFogEnd;
    
    public ArtisanalFluidType(FluidType.Properties properties, Vector3f color, float shaderFogStart, float shaderFogEnd) {
        super(properties);
        this.color = color;
