// TODO: No remainder shapeless Item Stack Modifier
...
//    
//     public SpecificNoRemainderShapelessRecipe(ResourceLocation id, ItemStackProvider result, NonNullList<Ingredient> ingredients, @Nullable Ingredient primaryIngredient) {
//         super(ingredients, result, new ItemStackProvider(), primaryIngredient);
