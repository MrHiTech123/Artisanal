...
public class ScalablePotRecipeCategory extends PotRecipeCategory<PotRecipe>
{
    ...
    public ScalablePotRecipeCategory(RecipeType<PotRecipe> type, IGuiHelper helper)
    {
